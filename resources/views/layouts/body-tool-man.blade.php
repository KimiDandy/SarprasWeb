    ...
    ********************-->
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="{{ route('dashboard-tool-man') }}" class="brand-logo">

                <img src="{{ asset('/') }}images/logo.png" width="56" alt="">
                <div class="brand-title">
                    <h2 class="" style="color: var(--primary);">ToolMan</h2>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="{{ route('dashboard-tool-man') }}" class="" aria-expanded="false">
                    ...
                    <li>
                        <a href="{{ route('history-tool-man') }}" class="" aria-expanded="false">
