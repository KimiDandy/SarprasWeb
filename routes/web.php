...
Route::middleware(['auth'])->group(function () {
    Route::middleware(CheckRole::class . ':Toolman')->group(function () {
        ...
        Route::get('/toolman/edit-data-siswa/{id}', [ToolmanController::class, 'editSiswa'])->name('edit-siswa');
        Route::post('/toolman/update-data-siswa/{id}', [ToolmanController::class, 'updateSiswa'])->name('update-siswa');
        Route::get('/toolman/delete-data-siswa/{id}', [ToolmanController::class, 'deleteSiswa'])->name('delete-siswa');
        ...
        Route::get('/toolman/delete-inventory/{id}', [ToolmanController::class, 'deleteInventory'])->name('delete.inventory');
